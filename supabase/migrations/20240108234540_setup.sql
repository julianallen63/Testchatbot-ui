...
AS $$
DECLARE
  project_url TEXT := 'https://xtevslbztjgrmjvvdgys.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inh0ZXZzbGJ6dGpncm1qdnZkZ3lzIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNzQxMjEyNiwiZXhwIjoyMDIyOTg4MTI2fQ.f9sGvEJePJr8-yYo-qWHPXWI9gBemxwskKt5e6gjBXw'; -- full access needed for http request to storage
